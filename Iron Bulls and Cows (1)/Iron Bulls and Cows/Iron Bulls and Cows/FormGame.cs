...
namespace Iron_Bulls_and_Cows
{
    public partial class MainForm : Form
    {
        ...
        private List<GameResult> gameLog;          

        
        private readonly string[] words3 = { "арв", "хур", "мыд", "мад", "фыд", "ных", "тых", "кад", "дур", "тиу", "дин", "был", "дон", "арт", "фос", "хос", "бон", "хай" };
        private readonly string[] words4 = { "фарн", "хъаз", "цард", "кард", "къух", "рухс", "цъиу", "дуар", "калм", "фырт", "зард", "дзул", "цыхт", "чызг", "нард", "бикъ" };
        private readonly string[] words5 = { "даргъ", "заман", "зарын", "цыргъ", "маргъ", "куыст", "дзырд", "дзыпп", "аууон", "куыдз", "галиу", "гауыз", "давын", "бындз" };
        ...
        private void SaveLogToFile()
        {
            try
            {
                ...
                MessageBox.Show("Лог сохранён в game_log.txt");
            }
            catch
            {
                MessageBox.Show("Не удалось сохранить лог.");
            }
        }
    }
}